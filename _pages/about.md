...
I also hold an M.S. in Electrical and Computer Engineering with a specialization in Control Systems Theory and Algorithms from the [University of Calgary](https://achulich.ucalgary.ca/electrical-software), and a B.S. in Electrical and Computer Engineering from [Tabriz University](https://ece.tabrizu.ac.ir/en).
